...
import com.rentalfilm.edgezuul.repository.JwtTokenRepository;
...
public class JwtTokenProvider {
    ...
    public UserDetails getUserDetails(String token) {
        ...
        UserDetails userDetails = new ZuulUserDetails(userName,roleList.toArray(new String[roleList.size()]));
        return userDetails;
    }
